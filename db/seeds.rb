...
moonrise_kingdom = Movie.create(title: "Moonrise Kingdom", overview: "an adorable lovestory between two children going on an adventure together. A story about friendhsip, childhood, family and love.", poster_url: "https://assets.libsyn.com/secure/content/95346806", rating: 9.0)
inglorious_basterds = Movie.create(title: "Inglorious Basterds", overview: "Germany during the second World War, and the Jews get revenge. It gets bloody.", poster_url: "https://m.media-amazon.com/images/M/MV5BOTJiNDEzOWYtMTVjOC00ZjlmLWE0NGMtZmE1OWVmZDQ2OWJhXkEyXkFqcGdeQXVyNTIzOTk5ODM@._V1_FMjpg_UX1000_.jpg", rating: 9.5)
